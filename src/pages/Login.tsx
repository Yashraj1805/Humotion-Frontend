        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-12 md:col-span-5">
            ...
            <p className="mt-8 text-base text-white/65 max-w-md">
              Pick up where you left off. Continue your sessions with Humo, monitor your MOS workspace, or update your business config.
            </p>
            <div className="mt-10 mono text-[10px] uppercase tracking-[0.22em] opacity-50 space-y-1">
              <div>$ humotionai auth --user</div>
              <div>{'> waiting for credentials'}<span className="caret">_</span></div>
            </div>
          </div>
          ...
          >
            <div className="border border-white/15 bg-black/40">
              ...
              <form onSubmit={submit} className="p-6 md:p-8 space-y-5">
                ...
                >
                  {loading ? <>authenticating<span className="caret">_</span></> : '▶ login'}
                </button>

                <div className="flex items-center justify-between mono text-[11px] uppercase tracking-[0.22em] pt-3 border-t border-white/10">
                  <Link to="/register" className="link-draw text-white/65 hover:text-white">
                    create account →
                  </Link>
